 ...
 * @LastEditTime: 2023-04-30 19:36:47
 * @FilePath: \React-ts-app\src\views\Sign\Sign.tsx
 */
import React, { useEffect, useState } from "react";
import styles from "./Sign.module.scss";
import { Button, Calendar, Descriptions, Row, Select, Space, Tag, message } from "antd";
...
export default function Sign() {
  ...
  return (
    <div>
      ...
      <Calendar cellRender={dateCellRender} locale={locale}   headerRender={({ value, type, onChange, onTypeChange }) => {
        const monthOption = [];
        for(let i = 0; i < 12; i++ ) {
